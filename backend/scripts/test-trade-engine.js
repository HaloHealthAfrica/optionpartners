...
const WEBHOOKS = {
  mtfBias_bullish: {
    ...
    event_id_raw: 'test-001',
    symbol: 'SPY',
    chart_tf: '15',
    bar: { close: 585.20, atr: 3.80 },
    mtf: {
      consensus: { bias_consensus: 'BULLISH', bias_score: 78, confidence_score: 0.82 },
      regime: { type: 'TREND', chop_score: 22, adx_15m: 32, atr_state_15m: 'EXPANSION' },
    },
    macro: { state: { macro_class: 'MARKUP', macro_strength: 78 } },
    space: { room_to_resistance: 'HIGH', room_to_support: 'MODERATE' },
    risk_context: { invalidation: { level: 578.00 }, atr: 3.80 },
    levels: { vwap: 583.50 },
    intent: { bias: 'LONG' },
  },
  ...
  mtfBias_bearish: {
    source: 'MTF_BIAS_ENGINE_V3',
    event_id_raw: 'test-001b',
    symbol: 'SPY',
    chart_tf: '15',
    bar: { close: 585.20, atr: 3.80 },
    mtf: {
      consensus: { bias_consensus: 'BEARISH', bias_score: 70, confidence_score: 0.75 },
      regime: { type: 'CHOP', chop_score: 68, adx_15m: 18, atr_state_15m: 'CONTRACTION' },
    },
    macro: { state: { macro_class: 'MARKDOWN', macro_strength: 70 } },
    space: { room_to_resistance: 'LOW', room_to_support: 'HIGH' },
    risk_context: { invalidation: { level: 590.00 }, atr: 3.80 },
    levels: { vwap: 587.00 },
    intent: { bias: 'SHORT' },
  },
